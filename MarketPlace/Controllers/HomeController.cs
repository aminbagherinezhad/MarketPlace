...
namespace MarketPlace.Controllers
{
    public class HomeController : SiteBaseController
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            ViewData["Product"] = await _productService.GetAllProducts(50);
            ViewData["Basket"] = await _productService.GetAllTBaskets(12);
        ...
        public async Task<IActionResult> AboutUs()
        {
            ...
            ViewData["result"] = await _productService.GetAllAbout(1);
            return View();
        }
