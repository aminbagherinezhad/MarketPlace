...
namespace MarketPlace.Areas.User.Controllers
{
    public class OrderController : UserBaseController
    {
        ...
        public OrderController(IOrderService orderService, IViewRenderService viewRender, IUserService userService, IPaymentService paymentService)
        {
        ...
        public async Task<IActionResult> PayUserOrderPrice()
        {
            ...
            string redirectUrl = "";//success page payment

            var status = _paymentService.CreatePaymentRequest(
                null,//TODO:Key zarinpal
                openOrderAmount,
            ...
            {
                SendEmail.Send("Microfiles23@gmail.com", "فاکتور سفارش","سفارش جدیدی ثبت شده است لطفا پیگیری نمایید ");//TODO : EMAIL FOR ADMIN
